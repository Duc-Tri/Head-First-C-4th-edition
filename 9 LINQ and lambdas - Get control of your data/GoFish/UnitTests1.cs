...
namespace GoFish
{
    ...
    public static class PlayerTests
        {
        [TestMethod]
        public static void TestGetNextHand()
            {
        ...
        public static void TestDoYouHaveAny()
            {
...
The end of the test checks the cards in the Player’s hand and verifies the Status property.
        */
        ...
        [TestMethod]
        public static void TestAddCardsAndPullOutBooks()
            {
                IEnumerable<Card> cards = new List<Card>()
                {
                new Card(Values.Jack, Suits.Spades),
            ...
            [TestMethod]
            public static void TestDrawCard()
            {
                var player = new Player("Owen", new List<Card>());
            ...
            [TestMethod]
            public static void TestRandomValueFromHand()
            {
